...
--
-- Table structure for table `usuario_albuns_favoritos`
--

DROP TABLE IF EXISTS `usuario_albuns_favoritos`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `usuario_albuns_favoritos` (
...
--
-- Dumping data for table `usuario_albuns_favoritos`
--

LOCK TABLES `usuario_albuns_favoritos` WRITE;
/*!40000 ALTER TABLE `usuario_albuns_favoritos` DISABLE KEYS */;
/*!40000 ALTER TABLE `usuario_albuns_favoritos` ENABLE KEYS */;
UNLOCK TABLES;
